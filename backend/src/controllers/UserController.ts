...
export class DeleteUserController {
	async delete(req: Request, res: Response) {
		...
		const user = await deleteUserService.execute(req, res);
...
export class ListarUsersController {
	async index(req: Request, res: Response) {
		...
		const user = await listarUserService.execute(req, res);
...
export class ListarUsersEmailController {
	async listarUsers(req: Request, res: Response) {
		...
		const user = await findUserByEmailService.execute({ email: String(email) }, req, res);
...
export class UpdateUserController {
	async update(req: Request, res: Response) {
		...
		const user = await updateUserService.execute({ id: Number(id), email, nome, cpf, telefone, password }, req, res);
...
export class findUserById {
	async find(req: Request, res: Response) {
		...
		const user = await findUserByIdService.execute({ id: Number(id) }, req, res);
